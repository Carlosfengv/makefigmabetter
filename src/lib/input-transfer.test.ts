...
describe("transferable input batches", () => {
  it("round-trips mixed pointer and wheel input without SharedArrayBuffer", () => {
    const events: EditorInputEvent[] = [
      { type: "pointer", event: "down", x: 10.5, y: -3.25, shiftKey: true, altKey: true, button: 0, drillDown: true, deepSelect: true, ignoreConstraints: true, splitVectorSegment: true, occurredAt: 123.5 },
