...
export const NODE_KIND_CAPABILITIES = {
  ...
  embed: capability({ renderPrimitive: "embedded-preview", entrySupport: { render: PARTIAL_SPECIAL_RENDER, export: PARTIAL_SPECIAL_EXPORT } }),
  ...
  linkUnfurl: capability({ renderPrimitive: "embedded-preview", entrySupport: { render: PARTIAL_SPECIAL_RENDER, export: PARTIAL_SPECIAL_EXPORT } }),
  media: capability({ renderPrimitive: "media", entrySupport: { render: PARTIAL_SPECIAL_RENDER, export: PARTIAL_SPECIAL_EXPORT } }),
