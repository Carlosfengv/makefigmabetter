...
export const RUNTIME_CAPABILITIES: readonly RuntimeCapability[] = [
  ...
  },
  {
    ...
    property: "getStyleByIdAsync|getLocalPaintStylesAsync|fillStyleId|setFillStyleIdAsync|strokeStyleId|setStrokeStyleIdAsync|backgroundStyleId|getStyleConsumersAsync",
    surface: "write",
    status: "supported",
    limitation: "Document PaintStyle resources apply their complete ordered PaintStack atomically, persist node link identity through semantics 46 and local Snapshot v61, report linked fields per consumer, and unlink without changing the current paints. Deprecated synchronous style setters require full-document access; async fill and stroke setters work with dynamic-page access. backgroundStyleId remains the deprecated synchronous frame-like alias defined by the Figma API.",
    errorCode: "RESOURCE_UNAVAILABLE",
  },
  {
