...
export const RUNTIME_CAPABILITIES: readonly RuntimeCapability[] = [
  ...
  },
  {
    ...
    editorTypes: ["figma"],
    documentAccess: RUNTIME_DOCUMENT_ACCESS_MODES,
    nodeTypes: ["FRAME", "GROUP", "SECTION", "COMPONENT", "INSTANCE", "SLOT", "SLICE", "RECTANGLE", "ELLIPSE", "POLYGON", "STAR", "VECTOR", "LINE", "TEXT", "CONNECTOR", "SHAPE_WITH_TEXT"],
    property: "createFrame|createGroup|createSection|createComponent|createComponentFromNode|ComponentNode.createInstance|ComponentNode.createSlot|createSlice|createRectangle|createEllipse|createPolygon|createStar|createVector|createLine|createText|createConnector|createShapeWithText",
    surface: "write",
    status: "partial",
