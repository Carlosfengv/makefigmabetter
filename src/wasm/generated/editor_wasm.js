 ...
 * @returns {string}
 */
export function layout_shaped_text_runs_with_layout_options_json(font_bundle, runs_json, text, max_width_px, first_line_indents_json, paragraph_wrap_styles_json, hanging_punctuation) {
    let deferred7_0;
    let deferred7_1;
    try {
        const ptr0 = passArray8ToWasm0(font_bundle, wasm.__wbindgen_malloc);
        ...
        const len4 = WASM_VECTOR_LEN;
        const ret = wasm.layout_shaped_text_runs_with_layout_options_json(ptr0, len0, ptr1, len1, ptr2, len2, max_width_px, ptr3, len3, ptr4, len4, hanging_punctuation);
        var ptr6 = ret[0];
        var len6 = ret[1];
        if (ret[3]) {
            ptr6 = 0; len6 = 0;
