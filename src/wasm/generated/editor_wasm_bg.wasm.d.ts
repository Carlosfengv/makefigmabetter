...
export const documentengine_preview_resize_transaction_json: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
export const documentengine_redo: (a: number) => [bigint, number, number];
export const documentengine_register_asset: (a: number, b: number, c: number, d: bigint, e: number, f: number, g: number, h: number, i: number, j: number, k: bigint, l: number, m: number, n: number, o: number) => [bigint, number, number];
...
export const documentengine_seed_document_id: (a: number, b: number, c: number) => [number, number];
...
export const rasterize_glyph_with_style_json: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number, number];
