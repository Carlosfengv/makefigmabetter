...
`F-PHASE1-RENDER-COMPOSITE` is the fixed Phase 1 image/shape/text input surface. Its resource bytes, PNG header and scene composition are checked by `pnpm check:phase1-render-composite-fixture`; a reviewed browser-image Golden has not yet been frozen.
